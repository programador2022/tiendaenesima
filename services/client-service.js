//Conexion
const listaProductos = () => fetch('https://jsonenesimo.herokuapp.com/productos').then(respuesta => respuesta.json());

const crearProducto = (nombre, precio, imagen, categoria, descripcion) => {
  return fetch('https://jsonenesimo.herokuapp.com/productos', {
    method: "POST",
    headers: {
...
const eliminarProducto = (id) => {
  return fetch(`https://jsonenesimo.herokuapp.com/productos/${id}`, {
    method: "DELETE"
  });
};
...
const detalleProducto = async (id) => {
  return fetch(`https://jsonenesimo.herokuapp.com/productos/${id}`).then( respuesta => respuesta.json());
};
